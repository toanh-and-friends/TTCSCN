...
path = "/media/toanh2612/Data/learn/Major/TTCSCN/deep_learning/CRNN_CTC/datasets/90kDICT32px"
...
print(orig_txt, train_label_length, train_input_length, training_txt)
