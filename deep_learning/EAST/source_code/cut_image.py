...
ig = ImagesData(output_folder_path='../datasets/ICDAR2015/test_data_output/2',
                image_file_path='../datasets/ICDAR2015/test_data/2.png',
                data_image_file_path='../datasets/ICDAR2015/test_data_output/2.txt')
