...
class TextDetection(object):
    def __init__(self, test_data_path, model_path, test_data_output_path, gpu_num):
        self.test_data_path = test_data_path
        self.model_path = model_path
        self.test_data_output_path = test_data_output_path
    ...
    def get_images(self):
        ...
        for parent, dirnames, filenames in os.walk(self.test_data_path):
    ...
    def predict(self):
        ...
        try:
            os.makedirs(self.test_data_output_path)
        except OSError as e:
            if e.errno != 17:
                raise
